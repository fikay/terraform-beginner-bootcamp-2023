// package main : Decllares the package name
// The main package is special in Go, it is where the execution of the program starts.
package main
...
// defines entry for the application
func main(){
